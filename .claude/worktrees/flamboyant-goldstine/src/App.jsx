    ...
    return (
      <div style={{
        ...
        <div style={{ background: '#1e293b', padding: '2.5rem', borderRadius: '1.5rem', border: '1px solid #334155', boxShadow: '0 25px 50px -12px rgba(0,0,0,0.5)', maxWidth: '450px' }}>
          <h1 style={{ color: '#ef4444', marginBottom: '1rem', fontSize: '1.8rem' }}>⚠️ Configuração Pendente</h1>
          <p style={{ color: '#94a3b8', marginBottom: '1.5rem', lineHeight: '1.6' }}>
            Não conseguimos encontrar as chaves de API necessárias. Certifique-se de configurar as variáveis no painel da Vercel ou no arquivo <code>.env</code>.
          </p>
          <div style={{ textAlign: 'left', background: '#0f172a', padding: '1rem', borderRadius: '0.5rem', fontFamily: 'monospace', fontSize: '0.85rem', color: '#60a5fa' }}>
            {!supabase && <div>❌ VITE_SUPABASE_URL<br/>❌ VITE_SUPABASE_ANON_KEY</div>}
            {!import.meta.env.VITE_GEMINI_API_KEY && <div>❌ VITE_GEMINI_API_KEY</div>}
          </div>
        </div>
      </div>
    );
